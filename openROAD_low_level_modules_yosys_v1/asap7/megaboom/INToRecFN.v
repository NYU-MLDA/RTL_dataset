module INToRecFN(
  ...
  assign _T_237 = normAbsIn[40:39];
  assign _T_238 = normAbsIn[38:0];
  assign _T_240 = _T_238 != 39'h0;
  ...
  assign _T_267 = normAbsIn[63:40];
  assign unroundedNorm = {1'h0,_T_267};
  assign _T_270 = unroundedNorm + 25'h1;
  assign _T_271 = _T_270[24:0];
  assign roundedNorm = round ? _T_271 : unroundedNorm;
  assign _T_272 = ~ normCount;
  assign unroundedExp = {1'h0,_T_272};
  assign _T_275 = {1'h0,unroundedExp};
  assign _T_276 = roundedNorm[24];
  assign _GEN_1 = {{7'd0}, _T_276};
  assign _T_277 = _T_275 + _GEN_1;
  assign roundedExp = _T_277[7:0];
  assign _T_278 = normAbsIn[63];
  assign expOut = {_T_278,roundedExp};
  assign _T_282 = roundedNorm[22:0];
