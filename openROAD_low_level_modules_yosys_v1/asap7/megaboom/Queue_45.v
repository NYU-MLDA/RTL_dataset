module Queue_45(
  ...
  reg  ram_error [0:1];
  reg [31:0] _GEN_6;
  wire  ram_error__T_110_data;
  wire  ram_error__T_110_addr;
  wire  ram_error__T_87_data;
  wire  ram_error__T_87_addr;
  wire  ram_error__T_87_mask;
  wire  ram_error__T_87_en;
  reg  _T_76;
  reg [31:0] _GEN_7;
  reg  _T_78;
  reg [31:0] _GEN_8;
  ...
  assign io_deq_bits_error = ram_error__T_110_data;
  ...
  assign ram_error__T_110_addr = _T_78;
  assign ram_error__T_110_data = ram_error[ram_error__T_110_addr];
  assign ram_error__T_87_data = io_enq_bits_error;
  assign ram_error__T_87_addr = _T_76;
  assign ram_error__T_87_mask = do_enq;
  assign ram_error__T_87_en = do_enq;
...
`ifdef RANDOMIZE
  ...
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    ram_data[initvar] = _GEN_5[127:0];
  `endif
  _GEN_6 = {1{$random}};
  `ifdef RANDOMIZE_MEM_INIT
  for (initvar = 0; initvar < 2; initvar = initvar+1)
    ram_error[initvar] = _GEN_6[0:0];
  `endif
...
`endif
  always @(posedge clock) begin
    ...
    if(ram_error__T_87_en & ram_error__T_87_mask) begin
      ram_error[ram_error__T_87_addr] <= ram_error__T_87_data;
    end
    if (reset) begin
      _T_76 <= 1'h0;
    end else begin
