#!/bin/bash
export DESIGN_NAME=prim_secded_72_64_enc
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/ibex/prim_secded_72_64_enc.v
export ABC_AREA=0
