...
export DESIGN_NAME=cr_file_0_5ba93c9db0cff93f52b521d7420e43f6eda2784f
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_area
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd/microwatt/cr_file_0_5ba93c9db0cff93f52b521d7420e43f6eda2784f.v
export ABC_AREA=1
