#!/bin/bash
export DESIGN_NAME=fetch1_1e2926114d55612f17be0ce20b92717fa98c0d5f
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd/microwatt/fetch1_1e2926114d55612f17be0ce20b92717fa98c0d5f.v
export ABC_AREA=0
