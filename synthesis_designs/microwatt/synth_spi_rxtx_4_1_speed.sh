#!/bin/bash
export DESIGN_NAME=spi_rxtx_4_1
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd/microwatt/spi_rxtx_4_1.v
export ABC_AREA=0
