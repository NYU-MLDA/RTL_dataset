#!/bin/bash
export DESIGN_NAME=eth_rxaddrcheck
export DESIGN_PAR=ethmac
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_speed
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/ethmac/eth_rxaddrcheck.v
export ABC_AREA=0
