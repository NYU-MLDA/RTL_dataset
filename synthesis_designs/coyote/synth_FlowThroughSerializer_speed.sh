#!/bin/bash
export DESIGN_NAME=FlowThroughSerializer
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/coyote/FlowThroughSerializer.v
export ABC_AREA=0
