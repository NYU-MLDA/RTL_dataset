#!/bin/bash
export DESIGN_NAME=bsg_counter_up_down_variable_max_val_p128_init_val_p128_max_step_p128
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/coyote/bsg_counter_up_down_variable_max_val_p128_init_val_p128_max_step_p128.v
export ABC_AREA=0
