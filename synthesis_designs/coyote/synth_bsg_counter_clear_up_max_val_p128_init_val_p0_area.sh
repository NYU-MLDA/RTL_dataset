...
export DESIGN_NAME=bsg_counter_clear_up_max_val_p128_init_val_p0
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_area
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/coyote/bsg_counter_clear_up_max_val_p128_init_val_p0.v
export ABC_AREA=1
