#!/bin/bash
export DESIGN_NAME=bsg_mux_one_hot_width_p73_els_p3
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/coyote/bsg_mux_one_hot_width_p73_els_p3.v
export ABC_AREA=0
