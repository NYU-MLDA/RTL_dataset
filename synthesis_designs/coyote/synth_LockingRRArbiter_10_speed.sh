#!/bin/bash
export DESIGN_NAME=LockingRRArbiter_10
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/coyote/LockingRRArbiter_10.v
export ABC_AREA=0
