#!/bin/bash
export DESIGN_NAME=sky130_ef_io__gpiov2_pad_wrapped
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hs/coyote_tc/sky130_ef_io__gpiov2_pad_wrapped.v
export ABC_AREA=0
