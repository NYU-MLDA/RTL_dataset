#!/bin/bash
export DESIGN_NAME=bsg_mem_1r1w_synth_width_p73_els_p128_read_write_same_addr_p0_harden_p0
export DESIGN_PAR=coyote_tc
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_speed
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hs/coyote_tc/bsg_mem_1r1w_synth_width_p73_els_p128_read_write_same_addr_p0_harden_p0.v
export ABC_AREA=0
