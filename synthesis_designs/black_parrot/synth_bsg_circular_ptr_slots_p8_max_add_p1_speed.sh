#!/bin/bash
export DESIGN_NAME=bsg_circular_ptr_slots_p8_max_add_p1
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/black_parrot/bsg_circular_ptr_slots_p8_max_add_p1.v
export ABC_AREA=0
