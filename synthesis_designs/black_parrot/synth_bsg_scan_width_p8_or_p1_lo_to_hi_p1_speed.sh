...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/black_parrot/bsg_scan_width_p8_or_p1_lo_to_hi_p1.v
export ABC_AREA=0
