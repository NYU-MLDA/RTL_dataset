#!/bin/bash
export DESIGN_NAME=bp_cce_inst_rom_width_p95_addr_width_p8
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/black_parrot/bp_cce_inst_rom_width_p95_addr_width_p8.v
export ABC_AREA=0
