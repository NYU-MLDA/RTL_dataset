...
export DESIGN_NAME=bsg_circular_ptr_slots_p32_max_add_p31
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_area
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/black_parrot/bsg_circular_ptr_slots_p32_max_add_p31.v
export ABC_AREA=1
