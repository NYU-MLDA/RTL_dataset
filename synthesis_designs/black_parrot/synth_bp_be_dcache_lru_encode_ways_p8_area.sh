...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/black_parrot/bp_be_dcache_lru_encode_ways_p8.v
export ABC_AREA=1
