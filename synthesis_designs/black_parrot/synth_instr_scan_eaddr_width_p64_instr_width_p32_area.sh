...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/black_parrot/instr_scan_eaddr_width_p64_instr_width_p32.v
export ABC_AREA=1
