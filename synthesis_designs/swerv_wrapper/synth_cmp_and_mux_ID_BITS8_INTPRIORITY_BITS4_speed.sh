#!/bin/bash
export DESIGN_NAME=cmp_and_mux_ID_BITS8_INTPRIORITY_BITS4
export DESIGN_PAR=swerv_wrapper
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_speed
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/swerv_wrapper/cmp_and_mux_ID_BITS8_INTPRIORITY_BITS4.v
export ABC_AREA=0
