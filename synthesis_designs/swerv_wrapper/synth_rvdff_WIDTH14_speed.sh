#!/bin/bash
export DESIGN_NAME=rvdff_WIDTH14
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/swerv_wrapper/rvdff_WIDTH14.v
export ABC_AREA=0
