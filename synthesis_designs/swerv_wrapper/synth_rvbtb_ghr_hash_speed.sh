#!/bin/bash
export DESIGN_NAME=rvbtb_ghr_hash
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/swerv_wrapper/rvbtb_ghr_hash.v
export ABC_AREA=0
