#!/bin/bash
export DESIGN_NAME=magcompare2c
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hs/riscv32i/magcompare2c.v
export ABC_AREA=0
