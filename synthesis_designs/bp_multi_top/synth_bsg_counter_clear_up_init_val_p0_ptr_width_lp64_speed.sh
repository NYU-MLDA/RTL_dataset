#!/bin/bash
export DESIGN_NAME=bsg_counter_clear_up_init_val_p0_ptr_width_lp64
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_multi_top/bsg_counter_clear_up_init_val_p0_ptr_width_lp64.v
export ABC_AREA=0
