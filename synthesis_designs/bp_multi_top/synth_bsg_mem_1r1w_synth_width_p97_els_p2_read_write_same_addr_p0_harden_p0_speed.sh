#!/bin/bash
export DESIGN_NAME=bsg_mem_1r1w_synth_width_p97_els_p2_read_write_same_addr_p0_harden_p0
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_multi_top/bsg_mem_1r1w_synth_width_p97_els_p2_read_write_same_addr_p0_harden_p0.v
export ABC_AREA=0
