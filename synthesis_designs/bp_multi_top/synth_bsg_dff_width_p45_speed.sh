#!/bin/bash
export DESIGN_NAME=bsg_dff_width_p45
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_multi_top/bsg_dff_width_p45.v
export ABC_AREA=0
