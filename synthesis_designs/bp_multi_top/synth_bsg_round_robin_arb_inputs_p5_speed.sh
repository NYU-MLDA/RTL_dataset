#!/bin/bash
export DESIGN_NAME=bsg_round_robin_arb_inputs_p5
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_multi_top/bsg_round_robin_arb_inputs_p5.v
export ABC_AREA=0
