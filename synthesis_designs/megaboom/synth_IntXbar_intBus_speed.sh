#!/bin/bash
export DESIGN_NAME=IntXbar_intBus
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/megaboom/IntXbar_intBus.v
export ABC_AREA=0
