...
export DESIGN_NAME=MemAddrCalcUnit
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_area
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/megaboom/MemAddrCalcUnit.v
export ABC_AREA=1
