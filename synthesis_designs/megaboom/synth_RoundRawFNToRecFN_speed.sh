#!/bin/bash
export DESIGN_NAME=RoundRawFNToRecFN
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/megaboom/RoundRawFNToRecFN.v
export ABC_AREA=0
