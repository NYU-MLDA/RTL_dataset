#!/bin/bash
export DESIGN_NAME=TLXbar_cbus
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/megaboom/TLXbar_cbus.v
export ABC_AREA=0
