#!/bin/bash
export DESIGN_NAME=TLDebugModule_debug
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/megaboom/TLDebugModule_debug.v
export ABC_AREA=0
