#!/bin/bash
export DESIGN_NAME=AXI4FragmenterAXI4FragmenterSideband
export DESIGN_PAR=megaboom
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_speed
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/asap7/megaboom/AXI4FragmenterAXI4FragmenterSideband.v
export ABC_AREA=0
