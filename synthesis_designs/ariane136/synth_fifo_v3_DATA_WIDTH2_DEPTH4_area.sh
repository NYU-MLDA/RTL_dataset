...
export DESIGN_NAME=fifo_v3_DATA_WIDTH2_DEPTH4
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_area
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/fifo_v3_DATA_WIDTH2_DEPTH4.v
export ABC_AREA=1
