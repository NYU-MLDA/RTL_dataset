#!/bin/bash
export DESIGN_NAME=tag_cmp_4_0000000c_00000008
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/tag_cmp_4_0000000c_00000008.v
export ABC_AREA=0
