#!/bin/bash
export DESIGN_NAME=pipe_reg_simple_Depth0
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/pipe_reg_simple_Depth0.v
export ABC_AREA=0
