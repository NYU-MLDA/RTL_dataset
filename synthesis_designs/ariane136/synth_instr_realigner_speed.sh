#!/bin/bash
export DESIGN_NAME=instr_realigner
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/instr_realigner.v
export ABC_AREA=0
