#!/bin/bash
export DESIGN_NAME=ariane_regfile_64_2_00000002_1
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/ariane_regfile_64_2_00000002_1.v
export ABC_AREA=0
