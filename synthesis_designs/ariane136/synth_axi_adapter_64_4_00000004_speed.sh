#!/bin/bash
export DESIGN_NAME=axi_adapter_64_4_00000004
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/axi_adapter_64_4_00000004.v
export ABC_AREA=0
