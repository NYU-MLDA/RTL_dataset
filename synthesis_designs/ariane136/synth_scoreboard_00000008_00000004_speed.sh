#!/bin/bash
export DESIGN_NAME=scoreboard_00000008_00000004
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd_fakestack/ariane136/scoreboard_00000008_00000004.v
export ABC_AREA=0
