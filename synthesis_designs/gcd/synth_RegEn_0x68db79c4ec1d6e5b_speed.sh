#!/bin/bash
export DESIGN_NAME=RegEn_0x68db79c4ec1d6e5b
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/gcd/RegEn_0x68db79c4ec1d6e5b.v
export ABC_AREA=0
