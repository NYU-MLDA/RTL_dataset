#!/bin/bash
export DESIGN_NAME=Mux_0x683fa1a418b072c9
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/gcd/Mux_0x683fa1a418b072c9.v
export ABC_AREA=0
