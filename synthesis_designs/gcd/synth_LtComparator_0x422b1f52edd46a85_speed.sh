#!/bin/bash
export DESIGN_NAME=LtComparator_0x422b1f52edd46a85
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/gcd/LtComparator_0x422b1f52edd46a85.v
export ABC_AREA=0
