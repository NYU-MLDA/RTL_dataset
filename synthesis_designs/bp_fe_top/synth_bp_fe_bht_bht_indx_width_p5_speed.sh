#!/bin/bash
export DESIGN_NAME=bp_fe_bht_bht_indx_width_p5
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_fe_top/bp_fe_bht_bht_indx_width_p5.v
export ABC_AREA=0
