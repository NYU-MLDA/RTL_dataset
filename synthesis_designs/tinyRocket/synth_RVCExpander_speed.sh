#!/bin/bash
export DESIGN_NAME=RVCExpander
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/tinyRocket/RVCExpander.v
export ABC_AREA=0
