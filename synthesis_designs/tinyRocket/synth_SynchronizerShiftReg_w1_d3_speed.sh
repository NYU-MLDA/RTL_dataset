#!/bin/bash
export DESIGN_NAME=SynchronizerShiftReg_w1_d3
export DESIGN_PAR=tinyRocket
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_speed
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/tinyRocket/SynchronizerShiftReg_w1_d3.v
export ABC_AREA=0
