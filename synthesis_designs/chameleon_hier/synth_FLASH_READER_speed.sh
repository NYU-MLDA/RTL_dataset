#!/bin/bash
export DESIGN_NAME=FLASH_READER
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/sky130hd/chameleon_hier/FLASH_READER.v
export ABC_AREA=0
