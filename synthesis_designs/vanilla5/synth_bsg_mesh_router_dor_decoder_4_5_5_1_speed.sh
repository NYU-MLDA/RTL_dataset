#!/bin/bash
export DESIGN_NAME=bsg_mesh_router_dor_decoder_4_5_5_1
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/vanilla5/bsg_mesh_router_dor_decoder_4_5_5_1.v
export ABC_AREA=0
