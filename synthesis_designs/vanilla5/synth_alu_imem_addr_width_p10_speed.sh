#!/bin/bash
export DESIGN_NAME=alu_imem_addr_width_p10
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/vanilla5/alu_imem_addr_width_p10.v
export ABC_AREA=0
