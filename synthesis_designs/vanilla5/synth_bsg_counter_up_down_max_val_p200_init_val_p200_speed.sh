#!/bin/bash
export DESIGN_NAME=bsg_counter_up_down_max_val_p200_init_val_p200
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/vanilla5/bsg_counter_up_down_max_val_p200_init_val_p200.v
export ABC_AREA=0
