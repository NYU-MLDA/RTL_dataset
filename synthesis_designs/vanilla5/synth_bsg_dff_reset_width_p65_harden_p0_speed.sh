#!/bin/bash
export DESIGN_NAME=bsg_dff_reset_width_p65_harden_p0
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/vanilla5/bsg_dff_reset_width_p65_harden_p0.v
export ABC_AREA=0
