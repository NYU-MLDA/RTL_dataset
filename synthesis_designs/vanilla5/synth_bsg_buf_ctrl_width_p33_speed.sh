#!/bin/bash
export DESIGN_NAME=bsg_buf_ctrl_width_p33
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/vanilla5/bsg_buf_ctrl_width_p33.v
export ABC_AREA=0
