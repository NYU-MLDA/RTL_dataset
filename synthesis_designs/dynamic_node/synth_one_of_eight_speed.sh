#!/bin/bash
export DESIGN_NAME=one_of_eight
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/dynamic_node/one_of_eight.v
export ABC_AREA=0
