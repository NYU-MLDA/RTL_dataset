#!/bin/bash
export DESIGN_NAME=network_input_blk_multi_out
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/dynamic_node/network_input_blk_multi_out.v
export ABC_AREA=0
