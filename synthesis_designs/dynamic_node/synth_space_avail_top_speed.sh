#!/bin/bash
export DESIGN_NAME=space_avail_top
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/dynamic_node/space_avail_top.v
export ABC_AREA=0
