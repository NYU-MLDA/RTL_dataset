#!/bin/bash
export DESIGN_NAME=bus_compare_equal
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/dynamic_node/bus_compare_equal.v
export ABC_AREA=0
