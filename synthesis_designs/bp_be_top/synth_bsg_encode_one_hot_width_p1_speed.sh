#!/bin/bash
export DESIGN_NAME=bsg_encode_one_hot_width_p1
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_be_top/bsg_encode_one_hot_width_p1.v
export ABC_AREA=0
