#!/bin/bash
export DESIGN_NAME=bsg_decode_num_out_p8
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/tsmc65lp/bp_be_top/bsg_decode_num_out_p8.v
export ABC_AREA=0
