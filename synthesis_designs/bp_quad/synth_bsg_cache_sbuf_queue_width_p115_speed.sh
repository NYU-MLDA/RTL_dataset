#!/bin/bash
export DESIGN_NAME=bsg_cache_sbuf_queue_width_p115
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/bp_quad/bsg_cache_sbuf_queue_width_p115.v
export ABC_AREA=0
