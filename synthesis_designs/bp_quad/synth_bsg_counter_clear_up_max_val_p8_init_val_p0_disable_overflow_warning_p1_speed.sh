#!/bin/bash
export DESIGN_NAME=bsg_counter_clear_up_max_val_p8_init_val_p0_disable_overflow_warning_p1
export DESIGN_PAR=bp_quad
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_speed
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/bp_quad/bsg_counter_clear_up_max_val_p8_init_val_p0_disable_overflow_warning_p1.v
export ABC_AREA=0
