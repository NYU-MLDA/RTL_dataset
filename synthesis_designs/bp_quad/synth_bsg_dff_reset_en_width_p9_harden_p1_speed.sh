#!/bin/bash
export DESIGN_NAME=bsg_dff_reset_en_width_p9_harden_p1
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/bp_quad/bsg_dff_reset_en_width_p9_harden_p1.v
export ABC_AREA=0
