...
export DESIGN_NAME=bsg_mux2_gatestack_width_p9_harden_p1
export ROOT_DIR=/home/abc586/currentResearch/llm_ppa_predictor
export DUMP_DIR=${ROOT_DIR}/dump/${DESIGN_PAR}/${DESIGN_NAME}_area
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/bp_quad/bsg_mux2_gatestack_width_p9_harden_p1.v
export ABC_AREA=1
