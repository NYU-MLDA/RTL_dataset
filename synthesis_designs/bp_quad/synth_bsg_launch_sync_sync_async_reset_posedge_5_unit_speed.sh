#!/bin/bash
export DESIGN_NAME=bsg_launch_sync_sync_async_reset_posedge_5_unit
...
export VERILOG_FILE=/home/abc586/currentResearch/llm_ppa_predictor/openROAD_low_level_modules_yosys_v1/gf12/bp_quad/bsg_launch_sync_sync_async_reset_posedge_5_unit.v
export ABC_AREA=0
